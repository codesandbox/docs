...
We currently provide [Browser Sandboxes](/learn/sandboxes/editor-features) and [VM Sandboxes](/learn/vm-sandboxes/overview). Sandboxes have the following limitations:

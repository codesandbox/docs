...
Permission vary slightly between repositories, which extend the settings from GitHub and Sandboxes and Devboxes, which soley exist in CodeSandbox. 

## Devboxes and Sandboxes
### Private
Private Devboxes and Sandboxes can only be accessed by member of the workspace that own the Sandbox or Devbox. 
...
If you want to share a Devbox with the public, consider turning the Devbox into a template. That way, the VMs used to run the code and/or the preview won't be charged to your workspace.

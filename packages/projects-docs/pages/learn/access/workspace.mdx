...
A workspace provide a collaborative space where members can works on various projects. Members of a workspace that is part an organization will be members of the organziation. Each workspace may have a unique list of members who may have different roles and permissions. 

...
No. Boxy is exclusively available in devboxes and repositories. However, you can easily [fork a sandbox into a devbox](/tutorial/convert-browser-sandbox-cloud) to get access to Boxy. This is available through the "sparkles" icon at the bottom of the left sidebar, as seen below.

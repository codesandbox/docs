...
[Live sessions](/learn/vm-sandboxes/live-sessions) are available in VM Sandboxes. If you're currently using a Browser Sandbox but wish to start a live session, you need to [convert it](/tutorial/convert-browser-sandbox-cloud) to a VM Sandbox first.

### What should I do if I need more space for file uploads?
Converting your Sandbox or repository will provide you with more storage for your files.
...
If your project requires tests, we recommend using a VM Sandbox. They allow you to build and run your own tests within your project as needed.

...
Sandboxes are the ideal environment for rapid web development. CodeSandbox provides two development environments: Devboxes (which run in a microVM) and Sandboxes (which run using browser resources).
...
Unlike Sandboxes that run on your browser, Devboxes run on our [microVMs](/learn/environment/vm).
       ...
       Devboxes are great for prototyping any type of project. They can run both backend and front-end services.

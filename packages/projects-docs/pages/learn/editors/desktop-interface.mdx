...
Develop any repository or VM Sandbox in your VS Code Desktop app and enjoy uninterrupted use of all the extensions and keybindings you’ve already configured.
...
Once the extension is installed, you can open a VM Sandbox or repo branch from the Dashboard section, as shown below.
...
<br/>
## Live Collaboration
Collaboration is one of the core CodeSandbox features. Users who are active on a VM Sandbox or repository branch are on the same VM. That means that all the changes made by users active on the VM will be visible in real-time.

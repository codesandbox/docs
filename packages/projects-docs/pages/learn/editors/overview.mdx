...
There are two editor versions to choose from - web and desktop. All Sandboxes open in the web editor by default. However, you can select your prefered editor when you open a new VM Sandbox or import a repo.
...
**Install the CodeSandbox VS Code extension and open any branch or VM Sandbox directly in your VS Code editor.**

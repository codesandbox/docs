...
We are in the process of deprecating this integration and shifting towards the Dev Containers specification. For more information about Dev Containers, see the [Dev Containers](/learn/environment/devcontainers) page.
</Callout>

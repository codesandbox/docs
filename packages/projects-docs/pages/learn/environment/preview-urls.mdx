...
We're injecting code automatically in the preview to proxy `localhost:3000` and similar requests coming from the preview (e.g. your frontend code) to the right hostname. You can learn more about that in the [Preview](https://codesandbox.io/docs/learn/devboxes/preview) page.

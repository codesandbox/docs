...
This works both for VM Sandboxes and repositories.
...
When setting environment variables for VM Sandboxes, we ensure that any fork of this sandbox will not include these environment variables. Because of this, forks will be a bit slower, as we cannot clone the memory snapshot.

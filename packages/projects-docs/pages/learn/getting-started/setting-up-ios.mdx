...
> 💡 [Create a team](https://codesandbox.io/dashboard?create_team=true) to fully experience how CodeSandbox can [accelerate your team's workflow](https://codesandbox.io/develop-full-stack-apps).
...
Start coding in seconds by using one of the official [CodeSandbox templates](https://codesandbox.io/s/). It's a quick and easy way to get started with any technology without any setup required.

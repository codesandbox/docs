...
CodeSandbox has an integration with VS Code that allows you to use VS Code to edit sandboxes and repositories on CodeSandbox.
...
To get the most out of VS Code, like automatic extension installation, we recommend you to follow these [tips and tricks](/learn/getting-started/setting-up-repository#vscode-configuration).
...
Known and loved for years, this editor was built for rapid web development using only the power of the browser. All the features from this editor are gradually being added to the Unified Platfrom Editor. However, the browser editor remains available to everyone who still calls it home.

...
CodeSandbox is a cloud development environment that makes it easy for you to spin up a development environment in the cloud and start working on it, whether it's a small prototype or a big monolith with multiple services.

For prototyping we recommend to use [sandboxes](https://codesandbox.io/docs/learn/sandboxes/overview), for cloud development with a strong GitHub integration we recommend to use [repositories](https://codesandbox.io/docs/learn/repositories/overview).

...
Container Sandboxes are deprecated for [Devboxes](/learn/devboxes/overview). You can find more info about configuring Devboxes [here](/learn/environment/devcontainers).
</Callout>

...
Container Sandboxes are deprecated for [VM Sandboxes](/learn/vm-sandboxes/overview). You can find more info about configuring VM Sandboxes on the [Dev Containers](/learn/environment/devcontainers) page.
</Callout>

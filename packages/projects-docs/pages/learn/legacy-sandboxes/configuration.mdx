...
Container Sandboxes are deprecated for [Devboxes](/learn/devboxes/overview). You can find more info about configuring Devboxes on the [Dev Containers](/learn/environment/devcontainers) page.
</Callout>

...
![Custom upgrae](../images/subscribe-prepurchase.png)

This will take you to a checkout page that allows you to set the number of team members you would like to allot to the team.

If you have already created a team, you can find the same option available on the team settings page.  
...
Yes, trials do not require a credit card to sign up. Once you start a trial, you will need to add payment details in order to continue with the Pro experience once the trial expires. 

...
**Sandboxes**: Your personal workspace contains any public sandboxes created while your personal workspace. If you want to make any of these sandboxes unlisted or private, you will need to create a [Pro workspace](##pro-workspace) and transfer the sandboxes to that workspace. 
...
You can learn how to work with collaborators in the sections on [repository](/learn/repositories/collaborate-share) and [sandbox]() collaboration

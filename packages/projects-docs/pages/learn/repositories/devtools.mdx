...
You can control the name and position of your DevTools, as well as define which DevTools run when you open the Web Editor. Check the [`tasks.json`](./task) documentation for more information on how to configure the DevTools.

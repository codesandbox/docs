...
**1. Navigation**
    ...
    - **Branch**: Tap to rename the current branch, switch branch or create new branch.

**2. Connections**
    - **Avatars**: See who's currently online and tap to follow their actions.
...
<Callout emoji="⭑">
    You can drag and drop elementes in the Files Explorer. 
</Callout>

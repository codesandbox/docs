...
<Callout emoji="⭐">During the final step, this setting will generate a `tasks.json` file. There are many more ways to use this file for advanced configuration that are described on the [Tasks](../task) page.</Callout>

...
When you run your repository in CodeSandbox, you are running it on a micro virtual machine (VM). This means that we need some basic configuration to set the environment on which your repository will run. To do this, we take advantage of the open source [Development Containers](https://containers.dev/). 

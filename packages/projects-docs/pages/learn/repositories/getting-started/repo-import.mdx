...
<Callout emoji="💡">OAuth permissions allow CodeSandbox to list the repositories you have access to as well as permsision to execute git actions that allows the editor to stay up-to-date as you code.</Callout>

...
Repositories are run on microVMs. When you press `Create Branch`, we automatically create a new branch and set up a development environment with running dev servers within a few seconds by cloning the microVM you branch from. You can read more about how this works [here](https://codesandbox.io/blog/how-we-clone-a-running-vm-in-2-seconds).

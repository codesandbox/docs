...
### Comments
You can add a comment by opening a diff file and hovering your mouse by the diff line and selecting the `+` icon to left of the line number, as highlighted below.

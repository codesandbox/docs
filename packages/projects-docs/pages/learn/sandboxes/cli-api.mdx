...
If you want to override any of these settings, you can create a `template.json` in the `.codesandbox` folder. You can find more info about this setting on the [Synced Templates](/learn/sandboxes/synced-templates#configuring-a-title-icon--description) page.

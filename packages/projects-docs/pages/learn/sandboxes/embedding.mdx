...
Embeds are currently supported as a beta feature for cloud sandboxes and repositories. While these provide fewer customization options as compared to browser sandboxes, they are much more powerful and support any programming language, not just JavaScript.

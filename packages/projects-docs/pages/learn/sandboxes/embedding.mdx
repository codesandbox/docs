...
Sandbox embeds enhance the learning and reading experience for anyone by providing a practical, interactive, and hassle-free way to explore and experiment with code examples. In addition, allows embeds users to interact with code examples directly from an article or blog post where can run, modify, and experiment with the code in a live environment. Also embeds ca be a great solution if you want to show examples of applications.
...
Additionally, Sandbox embeds still lack some of the customization options that are available in legacy sandbox embeds. 

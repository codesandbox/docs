...
<Callout>
MicroVM embeds are a feature of cloud sandboxes. If you have an example from a repository you want to embed, you can import the repository as a [synced template](/learn/sandboxes/synced-templates), which allows you to access (and embed) the code as a cloud sandbox.
</Callout>

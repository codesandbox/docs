...
Embeds are currently supported as a beta feature for cloud sandboxes. While these provide fewer customization options as compared to browser sandbox embeds, they are much more powerful and support any programming language, not just JavaScript.

<Tabs tabs={["Cloud Sandboxes", "Browser Sandboxes"]}>
    <WrapContent>

Cloud sandbox embeds are a great solution if you want to show examples of applications that go beyond front-end JavaScript (namely, other programming languages).

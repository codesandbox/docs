...
Embeds are now supported as a beta feature for cloud sandboxes. There are a few distinctions between browser and cloud sandbox embeds worth noting. Cloud sandboxes have more compute power do to the VM that they run on. They also support any programming language, not just JavaScript. That said, cloud sandbox embeds are currently limited in terms of interactions compared to browser sandboxes. 

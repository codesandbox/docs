...
<Callout>
Although cloud embeds are only available for cloud sandboxes, you can still embed a repository by first importing it as a [synced semplate](/learn/sandboxes/synced-templates).
</Callout>

...
If your project requires the use of a terminal or any additional advanced configuration like Docker, you can use a [Cloud Sandbox](/learn/sandboxes/overview?tab=cloud) instead.
    ...
    <WrapContent>
       ...
       Cloud Sandboxes are great for any prototyping needs and are suitable for any type of project. It can run both backend and frontend services.
       ...
       Cloud Sandboxes run on MicroVMs, this brings two features that make it great for prototyping:
       
       1. Fast cloning. You can fork a sandbox [within 2 seconds](https://codesandbox.io/blog/how-we-clone-a-running-vm-in-2-seconds), and continue with an exact clone of the VM. This way, you can quickly test multiple approaches to your prototype.
       2. Instant resume. Sandboxes will wake up within 1 second when you connect to them and continue with your running dev server. This way, you can quickly continue prototyping.

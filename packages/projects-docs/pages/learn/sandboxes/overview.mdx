...
If your project requires the use of a terminal or any additional advanced configuration like Docker, you can use a [Cloud Sandbox](/learn/sandboxes/overview?tab=cloud) instead.
    ...
    <WrapContent>
       ...
       - Full integration with GitHub
        ...
        To create a new sandbox from Github, change the GitHub url to `https://codesandbox.io/p/sandbox/github` + `/path/`. For example, here's a link to an Astro example sandbox from a subfolder -  https://codesandbox.io/p/sandbox/github/withastro/astro/main/examples/blog.
    </WrapContent>
</Tabs>
...
On Cloud Sandboxes, secrets are handled in the same way as Repositories, as you can read on the [Environment Variables page](/learn/environment/secrets).
...
<Callout>
        We're phasing out container sandboxes for cloud sandboxes. We recommend that you read the [documentation](/learn/environment/secrets) on how to apply secrets to cloud sandboxes.
</Callout>

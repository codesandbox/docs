...
<Callout>
        We're phasing out container sandboxes for VM Sandboxes. We recommend that you read the [documentation](/learn/environment/secrets) on how to apply secrets to VM Sandboxes.
</Callout>

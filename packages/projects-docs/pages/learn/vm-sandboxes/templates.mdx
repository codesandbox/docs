...
"Devbox Info" panel inside the editor. When viewing one of your VM Sandboxes,
...
![Make Template from VM Sandbox](../images/devbox-info-pane.png)

You can also create templates from the Dashboard. You can do this by either dragging and dropping a VM Sandbox from
...
to a regular VM Sandbox and remove it from the ["Create" modal](https://codesandbox.io/d).

You can then delete the VM Sandbox from your dashboard as you would normally. 

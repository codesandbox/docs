...
Disconnecting the session will end the session and automatically hibernate the sandbox after a timeout. You can alternatively hibernate the sandbox explicitly from the server.

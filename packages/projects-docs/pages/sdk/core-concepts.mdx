...
| --------- | --------------- | -------------------------------------------------------- |
| Memory | 0.5–2 seconds | Restores from an in-memory VM snapshot |
| Disk | 5–20 seconds | Boots from disk snapshot; slower, but retains full state |
| Archived | 20–60 seconds | Restores from cold storage; slowest but still resumable |
=======
...
✅ Always create Sandboxes from templates when possible for the fastest startup experience.

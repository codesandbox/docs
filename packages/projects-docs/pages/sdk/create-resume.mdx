...
The `sandbox` object represents the instance of a sandbox running in our infrastructure. You can use it to manage the sandbox and connect to it. In addition to its methods it has the following properties:

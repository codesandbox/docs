...
<Callout>
Note that when you resume a Sandbox it could be starting from a clean slate. This typically happens for Sandboxes that are around a week old without usage. That means its setup is going to run. Read more about [Setup](/sdk/setup) to learn more about this.
</Callout>

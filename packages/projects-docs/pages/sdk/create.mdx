...
Once you have [created a template](sdk/templates) using the CLI, you can use the returned template ID to create sandboxes. The template ID is only returned when you successfully build a template.
...
<Callout>
Each sandbox also has a `/project/sandbox` folder, but this has now been deprecated. Use `/project/workspace` for all new projects.
</Callout>

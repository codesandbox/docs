...
- **Be careful creating Sandbox from Sandbox** - When creating a Sandbox from a running or archived Sandbox, you risk a degraded experience. If your product requires this behavior, you will need long term persistence

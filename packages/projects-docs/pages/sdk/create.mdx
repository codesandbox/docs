...
Always use the CLI to create custom templates. This is what guarantees scalability and fast sandbox creation. Pre-built templates with snapshots ensure your sandboxes start quickly and consistently, rather than having to install dependencies and set up the environment each time.

...
- **Create templates for your specific use cases** - Don't fork Sandboxes creates on codesandbox.io
...
<Callout>
Even though automatic hibernation and automatic wakeup seems appealing, best practice is to invest in managing lifecycles on your own server. The hibernation timeout and wakeup has opinionated rules that can be good for initial testing, but will add cost and/or break UX at scale.
</Callout>

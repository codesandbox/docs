...
The fork method allows you to create a new Sandbox based on an existing one, copying its files and configuration while creating an independent instance.

<Callout type="warning" emoji="⚡">
**Best practices**

- **Avoid forking running Sandboxes** - Avoid using the `id` of a running sandbox as this creates a "live fork" which doesn't scale and can cause performance issues

...
The SDK can be used to run concurrent VMs to support multiple usecases such as AI agents, code interpretation and [more](./usecases.mdx)

## How it works

The API spins up a sandbox with a fresh VM in under 4 seconds. Inside this VM, you can run any code, install any dependencies and even run a server.

...
When you have `private` Sandboxes the hosts can not be accessed. You will need to generate a token to access the hosts. You create signed urls to your Sandboxes using the `hosts` API on the server:

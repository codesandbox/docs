...
By passing the users git access token the user will be able to use git commands inside the sandbox and access whatever the git token gives them access to.
...
By passing environment variables these variables will be available to the user inside the commands and terminals run by the user.

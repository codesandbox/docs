...
The `restartOn` option is deprecated and should not be used. You should manage the lifecycle of any processes from your application to avoid unpredictable behavior or accidentally sub optimize your templates.
</Callout>

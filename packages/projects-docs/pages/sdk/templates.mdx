...
- **Use the SDK** - Don't create templates on codesandbox.io, use the CLI
...
- **Use appropriate VM tiers** - Many processes requires quite a bit of memory and CPU to operate correctly. Make sure you give enough memory/cpu to the Sandbox

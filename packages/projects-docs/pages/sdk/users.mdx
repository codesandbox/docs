...
- **Configuring git/env** - Configure on Sandbox create and on resume in CLEAN state
...
If your Sandbox can be accessed by multiple users you should connect or create sessions with a `userId`. This ensures privacy and isolation between users.
